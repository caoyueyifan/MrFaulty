...
/**
 * Servlet implementation class ReporterID
 */
@WebServlet(
...
public class ReporterID extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LinkedList<FaultsStores> psl = Faults.getFaultByRId(Integer.parseInt(idReporter)); // Get a list of all faults
		...
		RequestDispatcher rd = request.getRequestDispatcher("/LFaultsByReporterid.jsp"); 
