...
/**
 * Servlet implementation class ReporterDelete
 */
@WebServlet(
		urlPatterns = { "/ReporterDelete/*" }, 
		initParams = { 
				@WebInitParam(name = "data-source", value = "jdbc/faultdb")
		})
public class ReporterDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private DataSource _ds = null;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReporterDelete() {
        super();
