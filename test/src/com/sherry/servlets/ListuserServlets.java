...
/**
 * Servlet implementation class ListuserServlets
 */
@WebServlet(
		urlPatterns = { 
				"/ListuserServlets", 
...
public class ListuserServlets extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private DataSource _ds = null; 
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListuserServlets() {
        super();
...
//		String args[]=Convertors.SplitRequestPath(request);
		...
		LinkedList<UserStores> psl = User.getUser(); // Get a list of all User
