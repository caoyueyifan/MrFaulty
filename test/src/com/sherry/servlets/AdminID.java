...
/**
 * Servlet implementation class AdminID
 */
@WebServlet(
		urlPatterns = { "/Admin/*" }, 
		initParams = { 
...
public class AdminID extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LinkedList<FaultsStores> psl = Faults.getFaultByAId(Integer.parseInt(idAdmin)); // Get a list of all faults
		...
		RequestDispatcher rd = request.getRequestDispatcher("/ListFaultByAID.jsp"); 
