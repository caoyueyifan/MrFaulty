...
/**
 * Servlet implementation class DeveloperID
 */
@WebServlet(
...
public class DeveloperID extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LinkedList<FaultsStores> psl = Faults.getFaultByDId(Integer.parseInt(idDeveloper)); // Get a list of all faults
		...
		RequestDispatcher rd = request.getRequestDispatcher("/ListFaultByDID.jsp"); 
