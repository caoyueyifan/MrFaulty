...
/**
 * Servlet implementation class ListFaultByID
 */
@WebServlet(
		urlPatterns = { "/Faults/*" }, 
		initParams = { 
...
public class ListFaultByID extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private DataSource _ds = null;  
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListFaultByID() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LinkedList<FaultsStores> psl = Faults.getFaultById(Integer.parseInt(idFault)); // Get a list of all faults
		...
		RequestDispatcher rd = request.getRequestDispatcher("/ListFaultByID.jsp"); 
