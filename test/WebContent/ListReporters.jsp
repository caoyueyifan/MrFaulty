...
while (iterator.hasNext()){
	...
	%>
	<tr>
	<td><a href="http://localhost:8080/test/Reporter/<%=md.getUserid() %>" ><%=md.getName() %></a></td>
	<td><a href = "http://localhost:8080/test/ReporterDelete/<%=md.getUserid()%>">Delete</a></td>
	</tr>
	 <%
}
}
...
Identity:<select name="identity"><option>Reporter</option></select><p>
