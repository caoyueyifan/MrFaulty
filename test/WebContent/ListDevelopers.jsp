...
while (iterator.hasNext()){
	...
	<tr>
	<td><a href="http://localhost:8080/test/Developer/<%=md.getUserid() %>" ><%=md.getName() %></a></td>
	<td><a href = "http://localhost:8080/test/DeveloperDelete/<%=md.getUserid()%>">Delete</a></td>
	</tr>
	 <%
}
}
...
Identity:<select name="identity"><option>Developer</option></select><p>
